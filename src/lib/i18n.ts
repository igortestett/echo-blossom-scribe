...
export const translations = {
  pt: {
    ...
    managePrivacySettings: "Gerenciar opções de privacidade",
  ...
  en: {
    ...
    managePrivacySettings: "Manage privacy options",
  ...
  es: {
    ...
    cookiePolicy: "Política de Cookies",
    managePrivacySettings: "Gestionar opciones de privacidad",
